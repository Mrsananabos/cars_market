...
public class Console {
    ...
    public Console(String filePath) {
        phraseProducer = new PhraseProducer(this.getClass().getClassLoader().getResource(filePath).getPath());
    }
    ...
    public static void main(String[] args) {
        Console console = new Console(Settings.getInstance().value("path"));
        console.start();
    }
}
