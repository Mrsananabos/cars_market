  ...
  insert into car_models(car_marks, name) values (1, 'honda1');
  insert into car_models(car_marks, name) values (1, 'honda2');
  insert into car_models(car_marks, name) values (1, 'honda3');
  insert into car_models(car_marks, name) values (2, 'KIA1');
  insert into car_models(car_marks, name) values (2, 'KIA2');
  insert into car_models(car_marks, name) values (2, 'KIA3');
  insert into car_models(car_marks, name) values (3, 'BMW1');
  insert into car_models(car_marks, name) values (3, 'BMW2');
  insert into car_models(car_marks, name) values (3, 'BMW3');
